...
describe "Timer" do
  ...
  describe 'time_string' do
    ...
    it "should display 156 seconds as 00:02:36" do
      @timer.seconds = 156
      @timer.time_string.should == "00:02:36"
    end

    it "should display 789 seconds as 00:13:09" do
      @timer.seconds = 789
      @timer.time_string.should == "00:13:09"
    end
    ...
    it "should display 40000 seconds as 11:06:40" do
      @timer.seconds = 40000
      @timer.time_string.should == "11:06:40"
    end
  end
